...
/**
 * Floating WhatsApp button. Opens a WhatsApp chat directly (with a friendly
 * prefilled message) — no pre-chat form. On mobile this deep-links straight
 * into the WhatsApp app.
 */
const PREFILL = "Hi Unexus AI, I'd like to know more about your services.";
